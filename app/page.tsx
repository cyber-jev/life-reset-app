...
// import { LogOut, FileText, Calendar, User as UserIcon } from 'lucide-react';
...
//               className={`flex items-center gap-2 px-5 py-3 font-medium transition relative ${
//                 activeTab === 'plan'
...
//           {/* GIF Demo – using absolute path from public folder */}
//           <div className="max-w-3xl mx-auto mb-12">
//             <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
//               <img
//                 src="/demo.gif"
//                 alt="App demo animation showing tracker and plan"
//                 className="w-full h-auto"
//                 onError={(e) => {
//                   // Fallback if GIF is missing – show a placeholder
//                   e.currentTarget.src = 'https://placehold.co/800x400?text=Demo+Preview+%28GIF+missing%29&font=roboto';
...
function AppContent() {
  ...
  // Handle email confirmation redirect (hash fragment)
  useEffect(() => {
    const hash = window.location.hash;
    if (hash && hash.includes('access_token')) {
      // Supabase can automatically exchange the hash for a session
      supabase.auth.getSession().then(({ data: { session } }) => {
        if (session) {
  ...
  if (processingHash) {
    return <div className="min-h-screen flex items-center justify-center">Confirming your email...</div>;
  }
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="/demo.gif"
                alt="App demo animation"
                className="w-full h-auto"
                onError={(e) => {
                  e.currentTarget.src = 'https://placehold.co/800x400?text=Demo+Preview&font=roboto';
                }}
              />
              <div className="p-4 bg-gray-50 flex items-start gap-3">
                <Info className="w-5 h-5 text-blue-500 mt-0.5" />
